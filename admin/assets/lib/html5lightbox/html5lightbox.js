    ...
    (function ($) {
        $.fn.html5lightbox = function (options) {
            ...
            if (
                ...
                (inst.options.isIPhone &&
                    inst.options.nativecontrolsoniphone) ||
            ...
            inst.readNodeData = function (node, parentNode) {
                ...
                inst.elemArray.push(
                    new Array(
                        ...
                        title,
                        group,
                        inst.checkParentData(node, parentNode, "width"),
                        inst.checkParentData(node, parentNode, "height"),
            ...
            inst.createMarkup = function () {
                ...
                inst.$lightbox = $(
                    "<div id='html5box-html5-lightbox' style='display:none;top:0px;left:0px;width:100%;height:100%;z-index:9999998;text-align:center;'>" +
                        ...
                        "<div class='html5-elem-wrap' style='display:block;position:relative;margin:0px auto;text-align:center;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;background-color:" +
                ...
                if (
                    ...
                    (inst.options.useabsoluteposonmobile &&
                        inst.options.isMobile)
                )
                ...
                if (inst.options.fullscreenmode) {
                    inst.$lightbox.append(
                        "<div class='html5-next-fullscreen' style='cursor:pointer;position:absolute;right:" +
                            inst.options.bordersize +
                            "px;top:50%;margin-top:-16px;'><img alt='' src='" +
                    ...
                    inst.$lightboxBox.append(
                        "<div class='html5-next-bottom-fullscreen' style='cursor:pointer;position:absolute;top:100%;right:0;margin-top:8px;'><img alt='' src='" +
                            inst.options.fullscreennextimage +
                            "'></div>" +
                            "<div class='html5-prev-bottom-fullscreen' style='cursor:pointer;position:absolute;top:100%;left:0;margin-top:8px;'><img alt='' src='" +
                            inst.options.fullscreenprevimage +
                            "'></div>"
                    );
                    inst.$nextbottom = $(
                    ...
                    inst.$lightboxBox.append(
                        "<div class='html5-next' style='display:none;cursor:pointer;position:absolute;right:" +
                            inst.options.bordersize +
                            "px;top:50%;margin-top:-32px;'><img alt='' src='" +
                    ...
                    if (
                        ...
                        inst.$lightboxBox.append(
                            "<div class='html5-next-touch' style='display:block;cursor:pointer;position:absolute;'><img alt='' src='" +
                                inst.options.nextimage +
                                "'></div>" +
                                "<div class='html5-prev-touch' style='display:block;cursor:pointer;position:absolute;'><img alt='' src='" +
                                inst.options.previmage +
                                "'></div>"
                        );
                        inst.$nexttouch = $(
            ...
            inst.loadElem = function (elem) {
                ...
                if (inst.options.preload) {
                    ...
                    if (
                        ...
                        new Image().src =
                            inst.elemArray[inst.options.prevElem][ELEM_HREF];
                }
            };
            ...
            (inst.showTitle = function (w, t, description) {
                ...
                if (inst.options.inGroup) {
                    ...
                    if (inst.options.showplaybutton)
                        text =
                            "<div class='html5-playpause' style='display:inline-block;cursor:pointer;vertical-align:middle;'><div class='html5-play' style='display:block;'><img alt='' src='" +
                ...
                if (inst.options.showsocialmedia)
                    if (inst.currentElem[ELEM_SOCIALMEDIA])
                        if (
                            $("#html5-socialmedia", inst.$lightboxBox).length >
                            0
                        )
                        ...
                        $("#html5-socialmedia", inst.$lightboxBox).length > 0
                    )
                            ...
                            var timercode =
                                !inst.options.showtimer || !inst.options.inGroup
                                    ...
                                    : "<div class='html5-timer' style='display:none;position:absolute;" +
                                      ...
                                      ";'></div>";
                            var titlecode =
                                elem[ELEM_WEBLINKTEXT] &&
                                elem[ELEM_WEBLINKTEXT].length > 0
                                    ? " title='" +
                                      elem[ELEM_WEBLINKTEXT].replace(
                                          /'/g,
                                          "&#39;"
                                      ) +
                                      "'"
            ...
            inst.showPDF = function (elem) {
                if (inst.options.enablepdfjs) {
                    if (
                        (inst.options.isIPhone &&
                            inst.options.openpdfinnewtaboniphone) ||
                        (inst.options.isIPad &&
                            inst.options.openpdfinnewtabonipad)
                    ) {
                ...
                inst.resizeLightbox(dataW, dataH, true, function () {
                    ...
                    if ($(divID).length > 0)
                        $(divID)
                            ...
                            .appendTo(
                                $(
                                    "#html5lightbox-div" + inst.options.curElem,
                                    inst.$image
                                )
                            );
                    else
            ...
            inst.showWeb = function (elem) {
                ...
                inst.resizeLightbox(dataW, dataH, true, function () {
                    ...
                    if (
                        ...
                        $(".html5lightbox-web-iframe", inst.$image).on(
                            "load",
                            function () {
            ...
            inst.calcElemSize = function (sizeObj, keepratio) {
                ...
                var topmargin =
                    $(window).height() < inst.options.smallscreenheight
                        ...
                        : inst.options.bordertopmargin;
                var h0 =
                    winH - navH - 2 * inst.options.bordersize - 2 * topmargin;
                if (inst.options.titlestyle == "bottom")
                ...
                if (inst.currentElem[ELEM_TYPE] == 0 && keepratio) {
                    ...
                    if (sizeObj.h > h0) {
                        if (keepratio)
                            sizeObj.w = Math.round(
                                (sizeObj.w * h0) / sizeObj.h
                            );
                        sizeObj.h = h0;
                    } else if (inst.options.maxheight) sizeObj.h = h0;
                    if (sizeObj.w > w0) {
                        if (keepratio)
                            sizeObj.h = Math.round(
                                (sizeObj.h * w0) / sizeObj.w
                            );
                        sizeObj.w = w0;
                    }
                }
            ...
            inst.resizeLightbox = function (elemW, elemH, bAnimate, onFinish) {
                ...
                if (
                    ...
                    if (
                        ...
                        if (
                            $(".html5-elem-box-previous", inst.$lightbox)
                                .length > 0
                        )
