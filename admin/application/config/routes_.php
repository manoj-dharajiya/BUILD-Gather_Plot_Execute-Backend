...
$route['business/add-claim-business-request'] = 'home/submit_claim_business';
$route['business-claim-verification/(:any)'] = 'home/verify_business_claim';
$route['edit-my-business/(:any)'] = 'home/edit_my_business';
...
$route['admin/business-claim-requests'] = 'admin/business_claim_requests';
$route['admin/business-claim-requests/page/(:any)'] = 'admin/business_claim_requests';
$route['admin/business-claim-request/edit/(:any)'] = 'admin/edit_business_claim_requests';
