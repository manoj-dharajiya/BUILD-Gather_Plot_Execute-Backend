              ...
              <div class="col-lg-12">
                <div class="p-5">
                  <div class="text-center mb-4 login-logo">
                    <img src="<?php echo base_url().'/assets/images/logo_black.png'?>" alt=""><br/>                    
                  </div>
                  ...
                  <?php if($message == "" || (!isset($message['type']))) {?>

                    <form method="post" class="user" id="update-password-form">
                      <div class="form-group">
                        <input id="password" name="password" type="password" class="form-control form-control-user" aria-describedby="emailHelp" placeholder="Password">
                        <span class="errMsg"></span>
                      </div>
                      <div class="form-group">
                        <input id="cpassword" name="cpassword" type="password" class="form-control form-control-user" aria-describedby="emailHelp" placeholder="Confirm Password">
                        <span class="errMsg"></span>
                      </div>
                  ...
                  <div class="text-center">
                    <a class="small" href="<?php echo base_url()?>login">Login</a> | <a class="small" href="<?php echo base_url()?>forgot-password">Forgot Password</a>
                  </div>                  
                </div>
              </div>
            </div>
