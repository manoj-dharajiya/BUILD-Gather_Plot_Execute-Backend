        ...
        <footer class="sticky-footer bg-white">
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    <span>Copyright &copy; Black Biz Database <?php echo date('Y'); ?></span>
                </div>
            </div>
        </footer>
        <!-- End of Footer -->
    ...
    <!-- <script src="<?php echo base_url();?>assets/lib/croppie/croppie.js"></script> -->
    <script src="<?php echo base_url();?>assets/lib/cropper/cropper.js"></script>
    <script src="<?php echo base_url();?>assets/lib/tinymce.min.js"></script>
